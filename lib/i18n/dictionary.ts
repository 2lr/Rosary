...
export const DICT = {
  fr: {
    ...
    'auth.forgotTitle': 'Retrouver l’accès',
    'auth.forgotBody': 'Donnez l’adresse de votre compte : nous vous enverrons un lien pour choisir un nouveau mot de passe.',
    'auth.forgotSend': 'Envoyer le lien',
    'auth.forgotSent': 'Si un compte existe à cette adresse, le lien vient de partir. Regardez vos indésirables si vous ne le voyez pas.',
    'auth.forgotUnconfigured': 'L’envoi d’e-mails n’est pas encore configuré sur ce serveur : aucun lien ne peut partir pour l’instant.',
    'auth.backToSignIn': 'Revenir à la connexion',
    'auth.newPassword': 'Nouveau mot de passe',
    'auth.resetTitle': 'Choisir un nouveau mot de passe',
    'auth.resetBody': 'Ce lien ne sert qu’une fois. Une fois le mot de passe choisi, vous serez connecté.',
    'auth.resetDo': 'Enregistrer et entrer',
    'error.invalidToken': 'Ce lien n’est plus valable. Demandez-en un nouveau.',
    'auth.code': 'Code d’invitation',
    'auth.codeHint': 'Le code de la personne qui vous invite — inutile si vous avez reçu un message de prière à cette adresse.',
    ...
    'error.invalidCode': 'Ce code ne correspond à personne, et cette adresse n’a reçu aucune invitation.',
    ...
    'home.forWhom': 'Prévenir quelqu’un',
    'home.forWhomHint': 'Son adresse recevra un mot quand le chapelet sera fini : quelqu’un a prié pour elle. Sans votre nom, et sans votre intention.',
    'home.forWhomPlaceholder': 'prenom@exemple.com',
    'home.alreadyPrayedShort': 'J’ai déjà prié ce chapelet',
    'home.alreadyPrayedOn': 'J’ai prié ce chapelet {date}',
    'home.prayedWhen': 'Prié quel jour ?',
    'home.yesterday': 'Hier',
    'home.otherDay': 'Un autre jour',
    'home.finishNow': 'Terminer',
    ...
    'notify.label': 'Rappels',
    'notify.title': 'Un rappel par jour',
    'notify.body': 'Une notification à l’heure que vous choisissez, et seulement si vous n’avez pas encore prié ce jour-là.',
    'notify.enable': 'Activer les notifications',
    'notify.enabled': 'Activées sur cet appareil',
    'notify.denied': 'Votre navigateur les a bloquées. Il faut les réautoriser dans ses réglages à lui.',
    'notify.unsupported': 'Ce navigateur ne sait pas les recevoir. Sur iPhone, ajoutez d’abord l’app à l’écran d’accueil.',
    'notify.hour': 'À quelle heure ?',
    'notify.hourOff': 'Aucun rappel',
    'notify.hourAt': '{h} h',
    'notify.lineage': 'Le soir, ce que votre lignée a prié',
    'notify.lineageHint': 'À 21 h, et seulement s’il y a quelque chose à dire.',
    'notify.off': 'Ne plus recevoir sur cet appareil',
    'notify.promptTitle': 'Vous rappeler de prier ?',
    'notify.promptBody': 'Une notification par jour, à l’heure que vous choisissez.',
    'notify.promptYes': 'Oui, me rappeler',
    'notify.promptLater': 'Plus tard',
    'journey.lineage': 'Priés grâce à vous',
    'install.label': 'Installer',
    'install.title': 'Mettre Rosaire sur l’écran d’accueil',
    'install.why': 'Elle s’ouvre alors comme une vraie application, sans barre d’adresse — et sur iPhone c’est la seule façon de recevoir les rappels.',
    'install.ios': 'Touchez le bouton Partager en bas de Safari, puis « Sur l’écran d’accueil ».',
    'install.android': 'Menu ⋮ en haut à droite de Chrome, puis « Installer l’application ».',
    'install.desktop': 'Cliquez l’icône d’installation à droite de la barre d’adresse.',
    'install.button': 'Installer maintenant',
    'install.done': 'C’est fait : vous y êtes déjà.',
    'mail.label': 'Messages envoyés',
    'mail.none': 'Vous n’avez encore prévenu personne.',
    'mail.sent': 'Envoyé',
    'mail.unconfigured': 'Pas encore configuré côté serveur — rien n’est parti.',
    'mail.failed': 'Refusé par le service d’envoi',
    'mail.too_many': 'Trop d’envois dans la journée',
    'mail.already_today': 'Déjà écrit à cette adresse aujourd’hui',
    'mail.retry': 'Renvoyer ces {n} messages',
    'mail.retry.one': 'Renvoyer ce message',
    'mail.retryBusy': 'Envoi…',
    'mail.retryDone': '{n} messages sont partis.',
    'mail.retryDone.one': 'Le message est parti.',
    'mail.retryNone': 'Rien n’est parti — la raison est ci-dessus.',
    'invite.label': 'Parrainage',
    'invite.title': 'Inviter quelqu’un',
    'invite.body': 'On n’entre ici que sur le code de quelqu’un. Voici le vôtre.',
    'invite.share': 'Partager mon code',
    'invite.copyLink': 'Copier le lien',
    'invite.copied': 'Copié',
    'invite.shareText': 'Je prie le chapelet avec {app}. Entrez avec mon code : {code}',
    'invite.invited': '{n} personnes invitées',
    'invite.invited.one': '1 personne invitée',
    'invite.people': '{n} en tout dans votre lignée',
    'invite.people.one': '1 en tout dans votre lignée',
    'invite.prayed': '{rosaries} rosaires priés grâce à vous · {decades} dizaines',
    'invite.prayedOne': '1 rosaire prié grâce à vous · {decades} dizaines',
    'invite.none': 'Personne encore. Le premier code que vous donnerez ouvrira votre lignée.',
    'invite.privacy': 'Vous voyez ce qui est prié, jamais par qui.',
    ...
    'novena.times': '{n} fois',
    'novena.dayCounts': 'Un jour validé compte {ave} Je vous salue Marie et {pater} Notre Père — ils font grandir votre rosaire.',
  ...
  en: {
    ...
    'auth.forgotTitle': 'Getting back in',
    'auth.forgotBody': 'Give the address of your account and we will send a link to choose a new password.',
    'auth.forgotSend': 'Send the link',
    'auth.forgotSent': 'If an account exists at that address, the link has just gone out. Check your spam if you do not see it.',
    'auth.forgotUnconfigured': 'Sending mail is not set up on this server yet, so no link can go out.',
    'auth.backToSignIn': 'Back to signing in',
    'auth.newPassword': 'New password',
    'auth.resetTitle': 'Choose a new password',
    'auth.resetBody': 'This link works once. Once the password is chosen you will be signed in.',
    'auth.resetDo': 'Save and come in',
    'error.invalidToken': 'This link is no longer valid. Ask for a new one.',
    'auth.code': 'Invitation code',
    'auth.codeHint': 'The code of whoever is inviting you — not needed if a prayer reached you at this address.',
    ...
    'error.invalidCode': 'That code belongs to nobody, and no invitation reached this address.',
    ...
    'home.forWhom': 'Tell somebody',
    'home.forWhomHint': 'Their address gets a word when the chaplet is finished: somebody prayed for them. Without your name, and without your intention.',
    'home.forWhomPlaceholder': 'name@example.com',
    'home.alreadyPrayedShort': 'I already prayed this chaplet',
    'home.alreadyPrayedOn': 'I prayed this chaplet on {date}',
    'home.prayedWhen': 'Prayed which day?',
    'home.yesterday': 'Yesterday',
    'home.otherDay': 'Another day',
    'home.finishNow': 'Finish',
    ...
    'notify.label': 'Reminders',
    'notify.title': 'One reminder a day',
    'notify.body': 'A notification at the hour you choose, and only if you have not prayed that day.',
    'notify.enable': 'Turn on notifications',
    'notify.enabled': 'On, on this device',
    'notify.denied': 'Your browser blocked them. They have to be allowed again in its own settings.',
    'notify.unsupported': 'This browser cannot receive them. On iPhone, add the app to the home screen first.',
    'notify.hour': 'At what hour?',
    'notify.hourOff': 'No reminder',
    'notify.hourAt': '{h}:00',
    'notify.lineage': 'In the evening, what your line prayed',
    'notify.lineageHint': 'At nine, and only when there is something to tell.',
    'notify.off': 'Stop them on this device',
    'notify.promptTitle': 'Remind you to pray?',
    'notify.promptBody': 'One notification a day, at the hour you choose.',
    'notify.promptYes': 'Yes, remind me',
    'notify.promptLater': 'Later',
    'journey.lineage': 'Prayed because of you',
    'install.label': 'Install',
    'install.title': 'Put Rosary on your home screen',
    'install.why': 'It then opens like a real app, with no address bar — and on iPhone it is the only way to receive the reminders.',
    'install.ios': 'Tap the Share button at the bottom of Safari, then “Add to Home Screen”.',
    'install.android': 'The ⋮ menu at the top right of Chrome, then “Install app”.',
    'install.desktop': 'Click the install icon at the right of the address bar.',
    'install.button': 'Install now',
    'install.done': 'Done — you are already there.',
    'mail.label': 'Messages sent',
    'mail.none': 'You have not told anybody yet.',
    'mail.sent': 'Sent',
    'mail.unconfigured': 'Not set up on the server yet — nothing went out.',
    'mail.failed': 'Refused by the mail service',
    'mail.too_many': 'Too many sent in one day',
    'mail.already_today': 'Already written to this address today',
    'mail.retry': 'Send these {n} again',
    'mail.retry.one': 'Send this one again',
    'mail.retryBusy': 'Sending…',
    'mail.retryDone': '{n} of them went out.',
    'mail.retryDone.one': 'It went out.',
    'mail.retryNone': 'Nothing went out — the reason is above.',
    'invite.label': 'Invitations',
    'invite.title': 'Invite someone',
    'invite.body': 'Nobody comes in here except on somebody’s code. Here is yours.',
    'invite.share': 'Share my code',
    'invite.copyLink': 'Copy the link',
    'invite.copied': 'Copied',
    'invite.shareText': 'I pray the rosary with {app}. Come in on my code: {code}',
    'invite.invited': '{n} people invited',
    'invite.invited.one': '1 person invited',
    'invite.people': '{n} in your line altogether',
    'invite.people.one': '1 in your line altogether',
    'invite.prayed': '{rosaries} rosaries prayed because of you · {decades} decades',
    'invite.prayedOne': '1 rosary prayed because of you · {decades} decades',
    'invite.none': 'Nobody yet. The first code you give opens your line.',
    'invite.privacy': 'You see what is prayed, never who prayed it.',
    'novena.label': 'Novena',
    ...
    'novena.dayCounts': 'A day marked counts {ave} Hail Marys and {pater} Our Father — they grow your rosary.',
