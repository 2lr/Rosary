...
export const DICT = {
  fr: {
    ...
    'auth.codeHint': 'Le code de la personne qui vous invite. On n’entre ici que sur invitation.',
    ...
    'error.invalidCode': 'Ce code ne correspond à personne.',
  ...
  en: {
    ...
    'auth.codeHint': 'The code of whoever is inviting you. Nobody comes in here uninvited.',
    ...
    'error.invalidCode': 'That code does not belong to anybody.',
